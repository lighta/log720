...
set MY_CLASSPATH=..\..\idl\target\classes:$CLASSPATH
set MY_CLASSPATH=..\..\server_poste\target\classes:..\..\server_voiture\target\classes:$CLASSPATH
set MY_CLASSPATH=..\..\client_poste\target\classes:..\..\client_voiture\target\classes:$CLASSPATH
